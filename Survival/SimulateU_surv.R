SimulateU_surv <- function(t, d, z, x, zetat, zetaz, theta = 0.5, iter = 20, weights = NULL, offset){
  #t is a vector of n, d is a vector of n, zetat is scaler, zetaz is a scaler
